        ...
        {product && (
          <div className=" flex flex-wrap my-5">
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <div className="flex">
                <button
                  className="text-xl bg-custom-black text-white px-4 py-2 flex items-center justify-between mb-4"
                  onClick={addToCart}
                >
                  <svg
              ...
              <div className="flex ">
                <Link to="/products" className="no-underline ">
                  <button className=" text-xl  bg-white w-auto text-custom-black px-4 py-3 flex items-center border-2 border-custom-black ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
